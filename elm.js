...
var _user$project$DarkJedi$nullInt = function ($int) {
	var _p0 = $int;
	if (_p0.ctor === 'Just') {
...
var _user$project$DarkJedi$nullString = function (str) {
	var _p1 = str;
	if (_p1.ctor === 'Just') {
...
var _user$project$DarkJedi$encodeDarkJediApprentice = function (record) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'url',
				_1: _user$project$DarkJedi$nullString(record.url)
			},
				{
				ctor: '_Tuple2',
				_0: 'id',
				_1: _user$project$DarkJedi$nullInt(record.id)
			}
			]));
};
var _user$project$DarkJedi$encodeDarkJediMaster = function (record) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
...
var _user$project$DarkJedi$encodeHomeworld = function (record) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
...
var _user$project$DarkJedi$encodeDarkJedi = function (record) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				{
				...
				ctor: '_Tuple2',
				_0: 'homeworld',
				_1: _user$project$DarkJedi$encodeHomeworld(record.homeworld)
			},
				{
				ctor: '_Tuple2',
				_0: 'master',
				_1: _user$project$DarkJedi$encodeDarkJediMaster(record.master)
			},
				{
				ctor: '_Tuple2',
				_0: 'apprentice',
				_1: _user$project$DarkJedi$encodeDarkJediApprentice(record.apprentice)
			}
			]));
};
var _user$project$DarkJedi$DarkJedi = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, homeworld: c, master: d, apprentice: e};
	});
var _user$project$DarkJedi$Homeworld = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _user$project$DarkJedi$decodeHomeworld = A3(
	...
	A3(
		...
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$DarkJedi$Homeworld)));
var _user$project$DarkJedi$Master = F2(
	function (a, b) {
		return {url: a, id: b};
	});
var _user$project$DarkJedi$decodeDarkJediMaster = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'id',
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$nullable(_elm_lang$core$Json_Decode$int),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'url',
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$nullable(_elm_lang$core$Json_Decode$string),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$DarkJedi$Master)));
var _user$project$DarkJedi$Apprentice = F2(
	function (a, b) {
		return {url: a, id: b};
	});
var _user$project$DarkJedi$decodeDarkJediApprentice = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'id',
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$nullable(_elm_lang$core$Json_Decode$int),
	A3(
		...
		'url',
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$nullable(_elm_lang$core$Json_Decode$string),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$DarkJedi$Apprentice)));
var _user$project$DarkJedi$decodeDarkJedi = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'apprentice',
	_user$project$DarkJedi$decodeDarkJediApprentice,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'master',
		_user$project$DarkJedi$decodeDarkJediMaster,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'homeworld',
			_user$project$DarkJedi$decodeHomeworld,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'name',
				_elm_lang$core$Json_Decode$string,
				A3(
					...
					'id',
					_elm_lang$core$Json_Decode$int,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$DarkJedi$DarkJedi))))));

var _user$project$FluxChallenge$buildSlot = function (slot) {
	var _p0 = slot;
	switch (_p0.ctor) {
		case 'Empty':
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('css-slot')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'Homeworld: ', _p1.homeworld.name))
							]))
					]));
		default:
			var _p2 = _p0._0;
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'Homeworld: ', _p2.homeworld.name))
							]))
					]));
	}
};
var _user$project$FluxChallenge$buildSlots = function (model) {
	return A2(_elm_lang$core$List$map, _user$project$FluxChallenge$buildSlot, model.jedis);
};
var _user$project$FluxChallenge$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('css-root')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('css-planet-monitor')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Obi-Wan currently on Tatooine')
							])),
						A2(
						_elm_lang$html$Html$section,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('css-scrollable-list')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('css-slots')
									]),
								_user$project$FluxChallenge$buildSlots(model)),
								A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('css-scroll-buttons')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('css-button-up')
											]),
										_elm_lang$core$Native_List.fromArray(
											[])),
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$class('css-button-down')
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									]))
...
var _user$project$FluxChallenge$Model = function (a) {
	return {jedis: a};
};
var _user$project$FluxChallenge$Nearby = function (a) {
	return {ctor: 'Nearby', _0: a};
};
var _user$project$FluxChallenge$Far = function (a) {
	return {ctor: 'Far', _0: a};
};
var _user$project$FluxChallenge$Empty = {ctor: 'Empty'};
var _user$project$FluxChallenge$doReplaceLastEmptyFromTop = F3(
	function (s, acc, l) {
		doReplaceLastEmptyFromTop:
		while (true) {
			var _p3 = l;
			if (_p3.ctor === '::') {
				if (_p3._0.ctor === 'Empty') {
					if (_p3._1.ctor === '[]') {
						return A2(
							_elm_lang$core$List_ops['::'],
							_user$project$FluxChallenge$Far(s),
							acc);
					} else {
						if (_p3._1._0.ctor === 'Empty') {
							var l = A2(_elm_lang$core$List$drop, 1, l);
							var acc = A2(_elm_lang$core$List_ops['::'], _user$project$FluxChallenge$Empty, acc);
							var _v2 = s,
								_v3 = acc,
								_v4 = l;
							s = _v2;
							acc = _v3;
							l = _v4;
							continue doReplaceLastEmptyFromTop;
						} else {
							var acc = A2(
								_elm_lang$core$List_ops['::'],
								_user$project$FluxChallenge$Far(s),
					...
					var acc = A2(_elm_lang$core$List_ops['::'], _p3._0, acc);
					var _v8 = s,
						_v9 = acc,
						_v10 = _p3._1;
					s = _v8;
...
var _user$project$FluxChallenge$replaceLastEmptyFromTop = F2(
	function (s, l) {
		return _elm_lang$core$List$reverse(
			A3(
				_user$project$FluxChallenge$doReplaceLastEmptyFromTop,
				s,
				_elm_lang$core$Native_List.fromArray(
					[]),
				l));
	});
var _user$project$FluxChallenge$replaceFirstEmptyFromBottom = F2(
	function (s, l) {
		var l = _elm_lang$core$List$reverse(l);
		return _elm_lang$core$List$reverse(
			A2(_user$project$FluxChallenge$replaceLastEmptyFromTop, s, l));
	});
var _user$project$FluxChallenge$updateList = function (masterApprentice) {
	var _p4 = masterApprentice;
	if (_p4.ctor === 'Master') {
		return _user$project$FluxChallenge$replaceLastEmptyFromTop;
	} else {
		return _user$project$FluxChallenge$replaceFirstEmptyFromBottom;
	}
};
var _user$project$FluxChallenge$Apprentice = {ctor: 'Apprentice'};
var _user$project$FluxChallenge$Master = {ctor: 'Master'};
var _user$project$FluxChallenge$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _user$project$FluxChallenge$FetchSucceed = F2(
	function (a, b) {
		return {ctor: 'FetchSucceed', _0: a, _1: b};
	});
var _user$project$FluxChallenge$fetchJedi = F2(
	function (masterApprentice, id) {
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
		...
		return A3(
			...
			_user$project$FluxChallenge$FetchFail,
			_user$project$FluxChallenge$FetchSucceed(masterApprentice),
			A2(_evancz$elm_http$Http$get, _user$project$DarkJedi$decodeDarkJedi, url));
	});
var _user$project$FluxChallenge$init = {
	ctor: '_Tuple2',
	_0: _user$project$FluxChallenge$Model(
		_elm_lang$core$Native_List.fromArray(
			[_user$project$FluxChallenge$Empty, _user$project$FluxChallenge$Empty, _user$project$FluxChallenge$Empty, _user$project$FluxChallenge$Empty, _user$project$FluxChallenge$Empty])),
	_1: A2(_user$project$FluxChallenge$fetchJedi, _user$project$FluxChallenge$Apprentice, 3616)
};
var _user$project$FluxChallenge$fetchEmpty = F3(
	function (jedis, masterApprentice, jedi) {
		var _p5 = masterApprentice;
		if (_p5.ctor === 'Master') {
			var _p6 = jedi.master.id;
			if (_p6.ctor === 'Just') {
				var _p7 = jedis;
				if ((_p7.ctor === '::') && (_p7._0.ctor === 'Empty')) {
					return A2(_user$project$FluxChallenge$fetchJedi, masterApprentice, _p6._0);
				} else {
			...
			var _p8 = jedi.apprentice.id;
			if (_p8.ctor === 'Just') {
				var _p9 = _elm_lang$core$List$reverse(jedis);
				if ((_p9.ctor === '::') && (_p9._0.ctor === 'Empty')) {
					return A2(_user$project$FluxChallenge$fetchJedi, masterApprentice, _p8._0);
				} else {
					return _elm_lang$core$Platform_Cmd$none;
				}
			} else {
...
var _user$project$FluxChallenge$update = F2(
	function (msg, model) {
		var _p10 = msg;
		switch (_p10.ctor) {
			case 'Up':
			...
			case 'FetchSucceed':
				var _p12 = _p10._0;
				var _p11 = _p10._1;
				var jedis = A3(_user$project$FluxChallenge$updateList, _p12, _p11, model.jedis);
				...
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(_user$project$FluxChallenge$fetchEmpty, model.jedis, _p12, _p11)
				};
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$FluxChallenge$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _user$project$FluxChallenge$init,
			update: _user$project$FluxChallenge$update,
			view: _user$project$FluxChallenge$view,
			subscriptions: function (_p13) {
				return _elm_lang$core$Platform_Sub$none;
			}
		})
};
var _user$project$FluxChallenge$Down = {ctor: 'Down'};
var _user$project$FluxChallenge$Up = {ctor: 'Up'};

var Elm = {};
Elm['FluxChallenge'] = Elm['FluxChallenge'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['FluxChallenge'], 'FluxChallenge', typeof _user$project$FluxChallenge$main === 'undefined' ? null : _user$project$FluxChallenge$main);
